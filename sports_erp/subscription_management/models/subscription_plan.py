...
class subscription_plan(models.Model):
    ...
    sessions = fields.Integer(string='No of Sessions', default='8')
    one2one = fields.Integer(string='No of One to One', default='4')
    stage_ids = fields.Many2many('project.task.type', 'sub_plan_id', string='Task stages')
