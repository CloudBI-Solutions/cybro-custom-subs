...
# Part of Softhealer Technologies.
{
    ...
    'summary': "Update Project Stage,Overdue Task Email,Project Checklist,Project Priority,Task Priority,Auto Project Task Stage,Task To Multiple User,Print Project Report,Task Auto Assign,Task Checklist,Task Custom Field,Update Task,Task Subtask,Task Timer odoo",
    ...
    'assets' : {
        'web.assets_backend' : [
            'sh_all_in_one_pms/static/src/js/time_track.js',
