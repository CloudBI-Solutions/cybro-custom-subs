                ...
                if comp_rec.start_date_bool:
                    ...
                    if task_search:
                        ...
                        for record in task_search:
                            ...
                            if record.user_ids:
                                if user != 0 and user != record.user_ids:
                                    ...
                                    if notify:
                                        ...
                                        if user_email_search:
                                            ...
                                            if notify:
                                                notify.unlink()
                                if record.user_ids[0].email :

                                    vals_line.update({
                                        'user_id': record.user_ids[0].id,
                                        'email_id': 1
                                    })
                                ...
                                comp = record.user_ids[0].company_id
                            ...
                            if record.user_ids:
                                ...
                                if record.user_ids[0].email:
                                    ...
                                    if record.project_id:
                                        ...
                                        nofity_obj = self.env[
                                            'project.task.overdue.notify'].create(
                                                vals_line)
