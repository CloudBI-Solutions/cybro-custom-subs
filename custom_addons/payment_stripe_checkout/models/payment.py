...
class AcquirerStripeCheckout(models.Model):
    ...
    provider = fields.Selection(selection_add=[('stripe_checkout', 'Stripe Checkout')], ondelete={'stripe_checkout': 'set default'})
    ...
    def _create_checkout_session(self, tx_data):
        ...
        session_dict['payment_intent_data[setup_future_usage]'] = 'off_session'
