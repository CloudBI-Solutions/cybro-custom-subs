...
class Assessments(models.Model):
    ...
    child_id = fields.Many2one("res.partner", 'Child', required=True,
                               store=True, tracking=True,
                               domain="['|', ('company_id', '=', False), "
                                      "('company_id', '=', company_id)]")
    ...
    img_ft_energy = fields.Image('Follow through step side view', store=True,
                                      max_width=500, max_height=1024,
                                      copy=False)
    img_ft_direction = fields.Image('Follow through 1,2,3 rear view', store=True,
                                 max_width=500, max_height=1024,
                                 copy=False)
